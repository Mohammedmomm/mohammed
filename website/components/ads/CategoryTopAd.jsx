...
export default function CategoryTopAd() {
  ...
  return (
    <div className="w-full overflow-hidden rounded-xl mb-6" style={{ border: '1px solid #162440' }}>
      <a
        href={ad.link_url || '#'}
        target="_blank"
        ...
        style={{ paddingTop: '18%', minHeight: 80 }}
      >
        {ad.image_url ? (
          ...
          <div
            ...
            style={{ background: '#162440', color: '#00D4FF' }}
          >
